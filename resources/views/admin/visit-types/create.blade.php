            ...
            <form action="{{ route('admin.visit-types.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('meeting_point') is-invalid @enderror" id="meeting_point" name="meeting_point" value="{{ old('meeting_point') }}" required>
                        @error('meeting_point')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('min_participants') is-invalid @enderror" id="min_participants" name="min_participants" value="{{ old('min_participants') }}" min="1" required>
                ...
                <div class="mt-3">
                    ...
                    <button type="submit" class="btn btn-primary">Add Visit Type</button>
                </div>
            </form>
        </div>
    </div>
