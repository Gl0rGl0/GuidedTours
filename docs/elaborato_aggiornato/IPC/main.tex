...
%                       
%                      usare \showimagesfalse - \showimagestrue
% ╚═════════════════════════════════════════════════════════════════════
...
% 6. Links and URLs (Hyperref ALWAYS last, Xurl extends it)
...
% --- Contatore problemi euristica (usato nel Cap. 3) ---
\newcounter{probcount}
...
\author{Daniel Barbetti\\Marco Cesari\\Giorgio Felappi}
\date{\today}
...
\include{capitoli/04_riprogettazione}
\include{capitoli/05_esperimento}
\include{capitoli/06_analisi_risultati}
\include{capitoli/07_sviluppi_futuri}
