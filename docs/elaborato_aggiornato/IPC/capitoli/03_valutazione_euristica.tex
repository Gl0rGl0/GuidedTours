...
% \vspace{0.1cm}
\textit{(screenshot non disponibile)} \\ \hline
\textbf{Principi violati} & 4 \\ \hline
\textbf{Numero valutatori} & 1 \\ \hline
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P1 -- Cursore non coerente su elementi cliccabili}
\end{table}
...
\end{tabularx}
\caption{P2 -- Assenza notifica rischio annullamento visita}
\end{table}
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P3 -- Semantica colore "Proposed"}
\end{table}
% D,G
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P4 -- Inconsistenza cromatica "Proposed"}
\end{table}
% tutti
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P5 -- Chiarezza nota pagamento}
\end{table}
% G
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P6 -- Stile nota pagamento}
\end{table}
% D,G
...
\end{tabularx}
\caption{P7 -- Ambiguità cromatica stati visita}
\end{table}
% tutti
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P8 -- Mancanza feedback disponibilità}
\end{table}
% M
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P9 -- Ridondanza "Visite confermate"}
\end{table}
% D
...
\begin{tabularx}{\textwidth}{|l|X|}
\hline
\textbf{\problemstep} & \textbf{Mancanza personalizzazione Homepage} \\ \hline
\textbf{Posizione} & Homepage \\ \hline
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P10 -- Mancanza personalizzazione Homepage}
\end{table}
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P11 -- Area cliccabile limitata}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P12 -- Gerarchia visiva debole}
\end{table}
% D
...
\textbf{Posizione} & Homepage \\ \hline
\textbf{Descrizione} & Dalle card delle visite in Homepage manca un collegamento diretto (shortcut) che indirizzi l'utente alla propria area personale/dashboard, compromettendo la libertà di navigazione e obbligando l'operatore a passaggi ridondanti per tornare all'hub di controllo centrale. \\ \hline
\textbf{Screenshot} & 
\vspace{0.1cm}
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P13 -- Assenza shortcut area personale}
\end{table}
% M
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P14 -- Incoerenza linguistica}
\end{table}
% M,G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P15 -- Visibilità ridotta logo}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P16 -- Mancanza toggle visibilità password}
\end{table}
% M

% RISOLTO CON STILE MENO IMPATTANTE
\begin{table}[H]
\centering
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|l|X|}
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P17 -- Navigazione ambigua verso "Register"}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P18 -- Ridondanza informativa Ruoli}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P19 -- Feedback di errore non user-friendly}
\end{table}
% tutti
...
\textbf{Grado di severità} & 3 \\ \hline
\end{tabularx}
\caption{P20 -- Assenza recupero password}
\end{table}
% M,G
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P21 -- Carico cognitivo posti disponibili}
\end{table}
% tutti
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P22 -- Navigazione ridondante verso "Login"}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P23 -- Ridondanza informativa Ruoli}
\end{table}
% G
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P24 -- Validazione tardiva input}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P25 -- Visibilità "Booking code"}
\end{table}
% tutti
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P26 -- Ambiguità etichetta "Participant"}
\end{table}
% D,G
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P27 -- Affordance ingannevole "My Booking"}
\end{table}
% D
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P28 -- Stile pulsante eliminazione}
\end{table}
% G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P29 -- Inconsistenza terminologica}
\end{table}
% D,G
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P30 -- Incoerenza spaziatura Header}
\end{table}
% G
...
\textbf{Screenshot} & \textit{(screenshot non disponibile)} \\ \hline
\textbf{Principi violati} & 5 \\ \hline
\textbf{Numero valutatori} & 1 \\ \hline
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P31 -- Validazione tardiva aggiunta utente}
\end{table}
% G
...
\end{tabularx}
\caption{P32 -- Assenza conferma eliminazione}
\end{table}
% tutti
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P33 -- Disorganizzazione del layout}
\end{table}
% G
...
\textbf{Grado di severità} & 3 \\ \hline
\end{tabularx}
\caption{P34 -- Flusso inserimento non intuitivo}
\end{table}
% G
...
\textbf{Grado di severità} & 3 \\ \hline
\end{tabularx}
\caption{P35 -- Mancanza feedback su vincoli}
\end{table}
% G
...
\textbf{Posizione} & Footer \\ \hline
\textbf{Descrizione} & Le mail nel footer assecondano un convenzionale stile ipertestuale, suggerendo interattività. La mancata risposta al click costituisce una grave violazione dell'affordance percepita. \\ \hline
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P36 -- Email non cliccabili}
\end{table}
% tutti
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P37 -- Mancanza selezione multipla nel calendario}
\end{table}
...
\textbf{Descrizione} & Nella pagina operativa delle visite assegnate vi è una carenza documentale (violazione euristica 10); la mancanza di indicazioni e promemoria procedurali (es. controllo biglietti, check-in) aumenta il carico cognitivo dell'operatore, abbandonandolo senza riferimenti operativi al momento del bisogno. \\ \hline
\textbf{Screenshot} & 
% \vspace{0.1cm}
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P38 -- Assenza indicazioni operative per Volontari}
\end{table}
...
\textbf{Grado di severità} & 1 \\ \hline
\end{tabularx}
\caption{P39 -- Ridondanza nome volontario nelle card}
\end{table}
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P40 -- Messaggio di stato vuoto senza Call to Action}
\end{table}
...
\textbf{Grado di severità} & 2 \\ \hline
\end{tabularx}
\caption{P41 -- Colore bottone non coerente}
\end{table}
...
\begin{figure}[H]
    \centering
    \input{capitoli/grafici/grafico_severita.tex}
    \caption{Distribuzione dei problemi per grado di severità (Scala Nielsen 1-4).}
    \label{fig:stat_severita}
\end{figure}

La matrice dei problemi individuati da ciascun valutatore è mostrata nella Figura~\ref{fig:matrice_errori}.
...
\begin{figure}[H]
    \centering
    \input{capitoli/grafici/grafico_principi.tex}
...
\begin{figure}[H]
    \centering
    \input{capitoli/grafici/grafico_valutatori.tex}
    \caption{Contributo dei valutatori per numero di problemi individuati.}
    \label{fig:stat_valutatori}
\end{figure}
...
\[ N_{tot} = \frac{N_{trovati}}{P(n)} = \frac{41}{0{,}67} \approx 61 \]
...
L'analisi euristica ha evidenziato un sistema funzionalmente completo ma caratterizzato da criticità strutturali nell'interazione e nella prevenzione dell'errore. Come si evince dai grafici, la maggior parte dei problemi è di natura estetica (Grado 1). Tuttavia emerge un nucleo consistente di \textbf{16 criticità di Grado 2}. Questi problemi generano ``attrito'' e disorientamento, obbligando l'utente a sforzi cognitivi evitabili a causa di incongruenze cromatiche e mancanze informative nei flussi principali.
