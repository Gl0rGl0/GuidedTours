...
\begin{tabularx}{\textwidth}{|l|X|}
\hline
\textbf{\problemstep} & \textbf{Mancanza personalizzazione Home Page} \\ \hline
...
% TODO: rigenerare i 3 grafici con i dati aggiornati (42 problemi, erano 32)
%   - grafico_severita.png  (Sev1=21, Sev2=16, Sev3=4, Sev4=1)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{capitoli/immagini/grafico_principi.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{capitoli/immagini/grafico_valutatori.png}
...
\[ N_{tot} = \frac{N_{trovati}}{P(n)} = \frac{42}{0.67} \approx 63 \]
Il calcolo teorico indica che il sistema potrebbe ospitare circa 63 problemi di usabilità totali, di cui 42 sono stati documentati in questa analisi.
