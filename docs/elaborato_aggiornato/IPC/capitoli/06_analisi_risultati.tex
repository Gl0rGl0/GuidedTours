...
\textbf{Metrica} & \textbf{Versione 1} & \textbf{Versione 2} \\
\hline
Completato & 8 (C), 4 (CA), 0 (NC) & 12 (C), 0 (CA), 0 (NC) \\ \hline
...
\textbf{Metrica} & \textbf{Versione 1} & \textbf{Versione 2} \\
\hline
Completato & 7 (C), 5 (CA), 0 (NC) & 12 (C), 0 (CA), 0 (NC) \\ \hline
...
\textbf{Metrica} & \textbf{Versione 1} & \textbf{Versione 2} \\
\hline
Completato & 6 (C), 5 (CA), 1 (NC) & 12 (C), 0 (CA), 0 (NC) \\ \hline
Tempo Medio & 175 s & 48 s \\ \hline
Click Medi & 12 & 3 \\ \hline
Errori Medi & 2.8 & 0.2 \\ \hline
Difficoltà (1-5) & 4.8 & 1.5 \\ \hline
Origine (1 Sito -- 5 Ute) & 1.1 & 3.8 \\ \hline
\end{tabular}
\end{table}
...
\textbf{Metrica} & \textbf{Versione 1} & \textbf{Versione 2} \\
\hline
Completato & 6 (C), 5 (CA), 1 (NC) & 11 (C), 1 (CA), 0 (NC) \\ \hline
